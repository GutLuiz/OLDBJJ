...
export default function Activities() {
  const cards: ActivityCard[] = [
    ...
    {
      title: "Turmas Adulto & Kids",
      description: "Treinos adaptados para o público adulto e infantil, do iniciante ao graduado, promovendo disciplina, técnica e máxima segurança.",
      icon: (
        <svg className="w-8 h-8 text-brand" fill="none" viewBox="0 0 24 24" stroke="currentColor">
